...
public class BlindataServiceIT extends MetaserviceAppIT {
    ...
    public void testDataProductCreation() throws JsonProcessingException, MetaServiceException {
        ...
        final PolicyEngineResource policyEngineResource = new PolicyEngineResource();
        ...
        NotificationResource notificationResource = objectMapper.readValue(notificationJson, NotificationResource.class);
