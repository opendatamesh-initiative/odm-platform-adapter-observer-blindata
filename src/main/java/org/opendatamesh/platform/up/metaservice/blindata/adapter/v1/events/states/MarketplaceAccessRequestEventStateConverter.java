...
import org.opendatamesh.platform.up.metaservice.blindata.resources.odm.notification.v1.eventstates.OdmExecutorResultReceivedEventState;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.stereotype.Component;

import static org.opendatamesh.platform.up.metaservice.blindata.adapter.v1.events.EventType.MARKETPLACE_EXECUTOR_RESULT_RECEIVED;


@Component
public class MarketplaceAccessRequestEventStateConverter implements EventStateConverter {
    ...
    private MarketplaceAccessRequestEventState convertState(JsonNode stateNode) throws JacksonException {
        OdmExecutorResultReceivedEventState odmState = objectMapper
                .configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false)
                .treeToValue(stateNode, OdmExecutorResultReceivedEventState.class);

        MarketplaceAccessRequestEventState marketplaceAccessRequestEventState = new MarketplaceAccessRequestEventState();
        marketplaceAccessRequestEventState.setAccessRequest(odmState.getAccessRequest());
        marketplaceAccessRequestEventState.setExecutorResponse(odmState.getExecutorResponse());
        return marketplaceAccessRequestEventState;
    }
}
